                    ...
                    <div className="flex-1">
                      ...
                      {calendarInstructionOpen && (
                        <div className="space-y-3 text-sm text-green-800 mt-3">
                          ...
                          <div className="bg-white/60 p-3 rounded-lg">
                            <p className="font-semibold mb-2 text-green-900">📋 Как пользоваться:</p>
                    ...
                    <div className="flex-1">
                      ...
                      {tipsContentOpen && (
                        <div className="space-y-3 text-sm text-green-800 mt-3">
                          ...
                          <div className="bg-white/60 p-3 rounded-lg">
                            <p className="font-semibold mb-2 text-green-900">📋 Основные действия:</p>
                          ...
                          <div className="bg-white/60 p-3 rounded-lg">
                            <p className="font-semibold mb-2 text-green-900">🔧 Действия с записью (меню "⋮"):</p>
